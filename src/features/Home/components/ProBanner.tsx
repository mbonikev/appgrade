...
const ProBanner = () => {
    return (
        <div className="mb-8">
            <div className="flex items-center justify-between rounded-full p-3 border border-linesColor">
                <div className="flex items-center space-x-3 text-sm text-textColor">
                    <span className="bg-textColor text-bodyBg text-xs font-bold px-1.5 py-0.5 rounded-full">PRO</span>
