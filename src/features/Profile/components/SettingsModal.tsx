...
import { RiCloseLine, RiSettings4Line, RiBankCardLine, RiDatabase2Line, RiAppsLine, RiNotification3Line, RiEqualizerLine, RiLogoutBoxRLine } from 'react-icons/ri';
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col bg-bodyBg">
                            ...
                            <div className="h-16 border-b border-linesColor flex items-center justify-between px-8">
                                ...
                                <button onClick={onClose} className="p-2 hover:bg-cardBg rounded-full text-textColorWeak hover:text-textColor transition-colors">
                            ...
                            <div className="flex-1 overflow-y-auto p-8">
                                {activeTab === 'general' && (
                                    <div className="max-w-2xl space-y-8">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid gap-6">
                                                <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                                                    <label className="text-textColorWeak text-sm font-medium">Your Name</label>
                                                    <input
                                                        type="text"
                                        ...
                                        {/* Account Section */}
                                        <div>
                                            <h3 className="text-textColor font-medium mb-4">Account</h3>
                                            <div className="grid gap-4">
                                                <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                                                    <label className="text-textColorWeak text-sm font-medium">Your Email</label>
                                                    <input
                                                        type="email"
                                        ...
                                        {/* Security Section */}
                                        <div>
                                            <h3 className="text-textColor font-medium mb-4">Security</h3>
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-textColorWeak text-sm font-medium">2 Step Verification</span>
